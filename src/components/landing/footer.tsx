        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" asChild>
              <Link href="https://github.com/Fixiuz/AlquilaTeam/issues/new?template=bug_report.md" target="_blank">
                <Bug className="h-4 w-4 mr-2" />
                Reportar un bug
              </Link>
            </Button>
            <Button variant="ghost" size="sm" asChild>
              <Link href="https://github.com/Fixiuz/AlquilaTeam" target="_blank">
                <Code className="h-4 w-4 mr-2" />
                Contribuir al Código
              </Link>
            </Button>
            <Button variant="ghost" size="sm" asChild>
              <Link href="https://github.com/Fixiuz/AlquilaTeam/blob/main/LICENSE" target="_blank">
